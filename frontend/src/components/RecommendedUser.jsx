...
const RecommendedUser = ({ user }) => {
  ...
  const { mutate: sendConectionRequest } = useMutation({
  ...
  const renderButton = () => {
    ...
    switch (connectionStatus?.data?.status) {
      ...
      default:
        return (
          <button
            className="px-3 py-1 rounded-full text-sm border border-primary hover:bg-primary horver:text-white transition-colors duration-200 flex items-center"
